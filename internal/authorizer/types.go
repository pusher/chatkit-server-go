...
type UpdateRolePermissionsOptions struct {
	AddPermissions    []string `json:"add_permissions,omitempty"`    // Permissions to add
	RemovePermissions []string `json:"remove_permissions,omitempty"` // Permissions to remove
}
